                    ...
                    <div class="order-card">
                        <div class="order-summary">
                            ...
                            <div class="summary-item">
                                ...
                                <span class="status-badge status-<?php echo htmlspecialchars(strtolower($order['order_status'])); ?>">
                                    <?php echo htmlspecialchars($order['order_status']); ?>
                                </span>
                            </div>
                            <div class="summary-item">
                                <strong>Total Price:</strong>
                                <span class="order-total">LKR. <?php echo number_format($orderTotal, 2); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="order-items">
                            <?php foreach ($order['items'] as $item) : ?>
                                <div class="order-item">
                                    <img src="productImgs/<?php echo htmlspecialchars($item['image_path']); ?>" alt="<?php echo htmlspecialchars($item['product_name']); ?>" class="product-image">
                                    <div class="product-details">
                                        ...
                                        <span class="product-price">LKR. <?php echo htmlspecialchars(number_format($item['price'] * $item['quantity'], 2)); ?></span>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
